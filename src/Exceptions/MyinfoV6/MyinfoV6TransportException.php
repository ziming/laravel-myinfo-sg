...
final class MyinfoV6TransportException extends RuntimeException implements JsonSerializable
{
    /** @var list<string> */
    ...
    public function __construct(
        ...
        if (! in_array($endpoint, self::ENDPOINTS, true)) {
            throw new InvalidArgumentException('The MyInfo V6 transport endpoint category is invalid.');
        }

        parent::__construct('The MyInfo V6 transport request could not be completed.', 0, $previous);
    }
    ...
    {
        throw new LogicException('MyInfo V6 transport exceptions cannot be serialized.');
    }
}
