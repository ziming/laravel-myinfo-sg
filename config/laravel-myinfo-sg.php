...
return [
    ...
    'attributes'    => env('MYINFO_APP_ATTRIBUTES', 'uinfin,name,sex,race,nationality,dob,email,mobileno,regadd,housingtype,hdbtype,marital,noa-basic,ownerprivate,cpfcontributions,cpfbalances'),
